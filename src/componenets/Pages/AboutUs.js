          ...
          <div className="col-md-6">
            <div className="text">
              ...
              <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                ...
                dolorem ipsum quia dolor.Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do
      ...
      <div className="rows">
        <div className="col-md-4">
          <div className="boxes1">
            <ul>
              <li><img src="..//web/images/about1-img.png" alt="" /></li>
              <li>
                <h3>Free Shipping</h3>
              </li>
              <li>
        ...
        <div className="col-md-4">
          <div className="boxes2">
            <ul>
              <li><img src="..//web/images/about2-img.png" /></li>
              <li>
        ...
        <div className="col-md-4">
          <div className="boxes3">
            <ul>
              <li><img src="..//web/images/about3-img.png" /> </li>
              <li>
